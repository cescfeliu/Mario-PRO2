/** @file list.hh
 *  @brief Especificación de la clase List
 */
...
/**
 * @class List
 * @brief Implementación de una lista doblemente enlazada con iteradores
 */
template <typename T>
class List {
 private:
    /**
     * @class Item
     * @brief Estructura interna del nodo de la clase List
     */
    class Item {
     public:
        T     value;
        ...
        Item(const T& val) : value(val), next(nullptr), prev(nullptr) {}
    };
 ...
 public:
    ...
    T& back()
    /* Pre: el p.i no és buit */
    /* Post: retorna una referència a l'últim node */
    {
        if (iteminf.next == &itemsup) {
            throw std::out_of_range("List is empty");
        }
        return itemsup.prev->value;
    }

    const T& back() const
    /* Pre: el p.i no és buit */
    /* Post: retorna una referència constant a l'últim node */
    {
        if (iteminf.next == &itemsup) {
            throw std::out_of_range("List is empty");
        }
    ...
    void clear()
    /* Pre: el p.i pot ser buit o no */
    /* Post: elimina tots els elements de la llista */
    {
        while (_size > 0) {
            removeItem(iteminf.next);
        }
    ...
    /**
     * @class iterator
     * @brief Iterador para la clase List
     */
    class iterator {
        friend class List;
     ...
     * @brief Iterador constante para la clase List
     */
    class const_iterator {
        friend class List;
